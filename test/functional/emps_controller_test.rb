...
class EmpsControllerTest < ActionController::TestCase
  ...
  test "should create emp" do
    assert_difference('Emp.count') do
      post :create, emp: { address: @emp.address, branch: @emp.branch, name: @emp.name, phneno: @emp.phneno }
    end
  ...
  test "should update emp" do
    put :update, id: @emp, emp: { address: @emp.address, branch: @emp.branch, name: @emp.name, phneno: @emp.phneno }
    assert_redirected_to emp_path(assigns(:emp))
  end
